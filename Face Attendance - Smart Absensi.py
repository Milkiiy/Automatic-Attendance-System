...
# judul
judul = tk.Label(root, text="Pengecekan Warga Komplek Nyonyo", font=("Roboto",25),bg="#242526", fg="white")
canvas.create_window(350, 80, window=judul)
#credit
made = tk.Label(root, text="Kel 2 COMVIS AA", font=("Times New Roman",13), bg="black",fg="white")
...
label1 = tk.Label(root, text="Nama Warga", font="Roboto", fg="white", bg="black")
...
label2 = tk.Label(root, text="NIK", font="Roboto", fg="white", bg="black")
...
label3 = tk.Label(root, text="Komplek", font="Roboto", fg="white", bg="black")
canvas.create_window(65, 250, window=label3)

global intructions

# tombol untuk rekam data wajah
intructions = tk.Label(root, text="Pilihan Menu", font=("Roboto",15),fg="white",bg="black")
